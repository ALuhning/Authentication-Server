 ...
 */
const appwss = koa_route_1.default.all('/ws/appauth', (ctx) => {
        ...
        try {
            ...
            switch (data.type) {
                case 'token': {
                     ...
                     * see ./hub.ts
                     */
                    const db = yield hub_helpers_1.newAppClientDB();
                    ...
                    const payload = Object.assign(Object.assign({}, auth), { token: token, key: process.env.ORG_API_KEY });
                    const returnData = {
                        type: 'token',
                        value: payload
                    };
...
exports.default = appwss;
//# sourceMappingURL=appwss.js.map