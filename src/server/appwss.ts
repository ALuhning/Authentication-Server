...
import {newAppClientDB, getAppAPISig} from "./hub-helpers"
 ...
 */
const AppDB: {[key: string]: AppModel} = {}
 ...
 */
const appwss = route.all('/ws/appauth', (ctx) => {
